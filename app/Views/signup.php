...
<body>
    ...
    <div class="signup_background">
        ...
        <div class="signup_container">
            <h1>SIGN UP</h1>
            <form name="signup" id="signup" method="POST" onsubmit="return validateForm()">
                ...
                <center><input type="password" placeholder="Confirm Password" id = "confirmpassword" name = "confirmpassword"></center><br>
